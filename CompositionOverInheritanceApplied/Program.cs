...
namespace CompositionOverInheritanceApplied
{
    // in this lesson we will apply the composition over inheritance principle to the Pizza class
    // we will create a Pizza class that can have toppings
    // we will create a ITopping interface that will have Title and Price properties
    // we will create a Tomato, Chicken, Cheese, BlackOlive, GreenPaper, Solami classes that will implement the ITopping interface
    // we will create a Pizza class that will have a list of ITopping
    // we will create a AddTopping method that will add a topping to the list
    // we will create a Calculate method that will calculate the total price of the pizza
    // we will override the ToString method to display the pizza details
    class Program
    {
